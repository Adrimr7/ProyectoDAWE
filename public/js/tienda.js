...
const productos = [
    ...
    new JetGrande("Boeing 737 Max", 229000000, "Para clientes que necesiten transportar a muchos pasajeros. La obra maestra de Boeing, un avión preparado para llegar a cualquier lugar del mundo, llevando a más pasajeros de los que probablemente se necesiten. Capacidad enorme y opción de adaptación para carga en vez de pasajeros (coste adicional a hablar con la empresa). ", "imagenes/jets/Boeing 737 Max.jpg", 172),
