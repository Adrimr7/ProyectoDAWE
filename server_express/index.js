...
aplicacion.use('/api/uploads', express.static(path.join(__dirname, 'public/uploads')));
...
aplicacion.use(cors({
  ...
  origin: ['http://localhost:3000', 'http://localhost:5000', 'http://134.122.104.67:3000', 'http://134.122.104.67:5000', 'https://134.122.104.67:3000', 'https://134.122.104.67:5000'],
  credentials: true,
